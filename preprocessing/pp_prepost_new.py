"""
Preprocessing script for subjects 14 and later. Takes into account the MIDI keyboard triggers.
...
for subject in subjects_to_process:
    ...
    #======================================================================================
        ...
        if check_events == True:
            ...
            #keystrokes
                ...
                plt.eventplot(events_MIDI[:,0], color = 'purple', lineoffsets = -6)
            else:
                ...
                plt.eventplot(events_MIDI[:,0], color = 'purple', lineoffsets = -7)
    ...
    #.....TO DO
        ...
        #======================================================================================
            ...
            events_2, events_3, events_4, events_5, events_6, section_start, events_MIDI = sort_events_MIDI(section_triggers, clean = True)
            ...
            indices_MIDI = (events_MIDI[:,0]) - section_start   
            ...
            #events_original[4][indices_6] = 1
            events_original[4][indices_MIDI] = 1
