...
#.....TO DO
    ...
    #======================================================================================
        ...
        savemat(os.path.join(output_dir,   f'{name}_{subject_ID}.mat'), {'all_electrodes': eeg_tosave[0:72], 'trial_data': eeg_tosave[0:64, :], 'trial_mastoids': eeg_tosave[64:66, :], 'trial_exg': eeg_tosave[66:72, :], 'events': events_resampled})
